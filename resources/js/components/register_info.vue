<template>
    <div class="create_account cstep-1">
        <div class="container">
            ...
            <form action="" id="step-1" class="" onsubmit="return false;">
                <div class="row row-cols-1 row-cols-xxl-2 row-cols-xl-2 row-cols-lg-2 row-cols-md-2">
                    ...
                    <div class="col agreement">
                        ...
                        understood the <span>NMSware Technologies</span> <a href="">Privacy Policy</a>
            ...
            <form action="" id="step-2" class="d-none" onsubmit="return false;">
                <div class="row row-cols-1 row-cols-xxl-2 row-cols-xl-2 row-cols-lg-2 row-cols-md-2">
                    <div class="col">
                        <div class="input">
            ...
            if (step == 3) {
                ...
                if (allow == true) {
                    ...
                    if (data.data['error'] == 0) {
                        ...
                        setTimeout(function () {
                            if (getUrlParam(window.location.search, 'ref') != false && getUrlParam(window.location.search, 'ref') == 'get_started' && getUrlParam(window.location.search, 'plan') == 'free') {
