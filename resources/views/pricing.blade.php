...
@section('content')
        ...
        <div class="container">
            ...
            <div class="pricing-wrap">
                ...
                <div class="basic" style="border-radius: 0 10px 10px 0;">
                    ...
                    <div class="features">
                        <ul>
                            <li><i class="fa-solid fa-check"></i> Incudes all premium features</li>
    ...
    <div class="faq">
        <div class="heading">
            ...
            <p class="text-center">Can't find the answer you're looking for ? <a href="/contact">Reach out to customer
                    support team.</a></p>
        </div>
